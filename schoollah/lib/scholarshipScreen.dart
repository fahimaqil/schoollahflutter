...
class ScholarshipScreen extends StatefulWidget {
  ...
  ScholarshipScreen({this.scholarship});
                ...
                Stack(
                  children: <Widget>[
                    Container(
                      ...
                      child: Hero(
                        tag: widget.scholarship.imageUrl,
                        child: ClipRRect(
                          borderRadius: BorderRadius.only(
                              bottomRight: Radius.circular(30),
                              bottomLeft: Radius.circular(30)),
                          child: Image(
                            image: AssetImage(widget.scholarship.imageUrl),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
